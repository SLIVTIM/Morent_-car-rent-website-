        ...
        <header className='header-wrapper'>
            ...
            <article className='user-stuff-wrapper'>
                ...
                <div className='user_stuff_svg notification_svg_wrapper'>
                    <svg className='bell-icon' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <title>bell notiffication icon</title>
